...
class ProductManager {
  ...
  //Agregar un producto al FS
  addProductFS(title, description, price, thumbnail, code, stock) {
    let productos = this.getProductsFS();
  ...
  //retorno el producto por ID del FS
  getProductByIdFS(id) {
    let productos = this.getProductsFS();
